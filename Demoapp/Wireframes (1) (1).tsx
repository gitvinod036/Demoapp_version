    ...
    <div className="p-6 bg-secondary/10">
      ...
      <Card className="p-5">
        ...
        <div className="space-y-3 text-sm">
          {[
            { label: "Policy clauses parsed", val: "14 / 14", ok: true },
            { label: "Coverage match", val: "Clause 4.2 ✓", ok: true },
            { label: "Exclusion check", val: "None triggered", ok: true },
            { label: "Fraud signals", val: "0 detected", ok: true },
            { label: "Document completeness", val: "5 / 5", ok: true },
          ].map((r) => (
  ...
  <div className="grid md:grid-cols-2 min-h-[500px]">
    ...
    <div className="p-6 bg-secondary/10">
      ...
      <div className="space-y-3">
        {[
          { icon: ShieldCheck, label: "Clause 4.2 — Collision coverage", note: "Direct match · 99% similarity", ok: true },
          { icon: ShieldCheck, label: "Clause 7.1 — FIR provided", note: "FIR_48721.pdf verified", ok: true },
          { icon: FileText, label: "Surveyor report", note: "Damage estimate: ₹2,38,500", ok: true },
          { icon: Eye, label: "Photo evidence (8 images)", note: "Damage location confirmed", ok: true },
          { icon: Clock, label: "Filed within 7-day window", note: "Incident: 26 Apr · Filed: 28 Apr", ok: true },
        ].map((e) => (
  ...
  return (
    <div className="p-6 md:p-8">
      <div className="flex justify-between items-center mb-5">
        ...
        <Badge className="bg-success">100% approved historically</Badge>
      </div>
